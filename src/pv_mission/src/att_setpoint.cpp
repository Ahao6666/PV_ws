...
/******************************************************************************
 * @file att_setpoint.cpp
 * @brief attitude setpoint node, written with MAVROS, PX4 Pro Flight
...
int main(int argc, char **argv)
{
    ...
    while(ros::ok()){
        ...
        // then publish setpoint position, otherwise publish the attitude setpoint.
        ...
        if(pose_pub){
            ...
            // switch the euler angle to quaternion
